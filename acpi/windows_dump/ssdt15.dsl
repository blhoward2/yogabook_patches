...
DefinitionBlock ("", "SSDT", 2, "DptfTb", "DptfTabl", 0x00001000)
{
    ...
    External (_SB_.PC00.LPCB.EC0_.ADAT, IntObj)
    ...
    External (_SB_.PC00.LPCB.EC0_.MPTS, IntObj)
    External (_SB_.PC00.LPCB.EC0_.SBTS, IntObj)
    External (_SB_.PC00.LPCB.EC0_.SSFT, IntObj)
    External (_SB_.PC00.LPCB.EC0_.STPM, IntObj)
    External (_SB_.PC00.LPCB.EC0_.SWIF, IntObj)
    External (_SB_.PC00.LPCB.EC0_.UQMM, IntObj)
    ...
    External (ODVN, IntObj)
    External (ODVO, IntObj)
    External (ODVQ, IntObj)
    ...
    Scope (\_SB)
    {
        OperationRegion (DNVS, SystemMemory, 0x63DF6000, 0x0035)
        ...
        Device (IETM)
        {
            ...
            Method (ODVP, 0, Serialized)
            {
                ...
                ODVX [0x15] = \_SB.ODVL
                ODVX [0x16] = \_SB.ODVM
                If ((\_SB.PC00.LPCB.EC0.UQMM == One))
                {
                    \_SB.ODVM = 0x03
                }
                ElseIf (((\_SB.PC00.LPCB.EC0.ADAT < 0x41) && (\_SB.PC00.LPCB.EC0.ADAT != Zero)))
                {
                    \_SB.ODVM = 0x02
                }
                Else
    ...
    Scope (\_SB.IETM)
    {
        Device (SEN2)
        {
            ...
            Name (_STR, Unicode ("Charger IC thermal sensor"))  // _STR: Description String
            Name (CTYP, Zero)
            Name (PFLG, Zero)
            Name (GTSH, 0x14)
            Name (SNID, One)
    ...
    Scope (\_SB.IETM)
    {
        Device (SEN3)
        {
            ...
            Name (_STR, Unicode ("wifi sensor"))  // _STR: Description String
            Name (CTYP, Zero)
            Name (PFLG, Zero)
            Name (GTSH, 0x14)
            Name (SNID, 0x02)
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (\_SB.PC00.LPCB.EC0.ECAV)
                {
                    If ((Acquire (\_SB.PC00.LPCB.EC0.LFCM, 0xA000) == Zero))
                    {
                        Local0 = \_SB.IETM.C10K ((\_SB.PC00.LPCB.EC0.SWIF * 0x0A))
                        Release (\_SB.PC00.LPCB.EC0.LFCM)
                        Return (Local0)
                    }
                }
    ...
    Scope (\_SB.IETM)
    {
        Device (SEN4)
        {
            ...
            Name (_STR, Unicode ("safty sensor"))  // _STR: Description String
            Name (CTYP, Zero)
            Name (PFLG, Zero)
            Name (GTSH, 0x14)
            Name (SNID, 0x03)
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (\_SB.PC00.LPCB.EC0.ECAV)
                {
                    If ((Acquire (\_SB.PC00.LPCB.EC0.LFCM, 0xA000) == Zero))
                    {
                        Local0 = \_SB.IETM.C10K ((\_SB.PC00.LPCB.EC0.SSFT * 0x0A))
                        Release (\_SB.PC00.LPCB.EC0.LFCM)
                        Return (Local0)
                    }
                }
    ...
    Scope (\_SB.IETM)
    {
        Device (SEN5)
        {
            ...
            Name (_STR, Unicode ("STP1 thermal sensor"))  // _STR: Description String
            Name (CTYP, Zero)
            Name (PFLG, Zero)
            Name (GTSH, 0x14)
            Name (SNID, 0x04)
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (\_SB.PC00.LPCB.EC0.ECAV)
                {
                    If ((Acquire (\_SB.PC00.LPCB.EC0.LFCM, 0xA000) == Zero))
                    {
                        Local0 = \_SB.IETM.C10K ((\_SB.PC00.LPCB.EC0.STPM * 0x0A))
                        Release (\_SB.PC00.LPCB.EC0.LFCM)
                        Return (Local0)
                    }
                }
